...
You need a machine with at least 20 GB free space with Debian 11 (bare-metal, virtual, Docker container with --privileged flag). Also, you need to install ansible and python packages:
